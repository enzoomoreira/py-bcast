...
async def brokers_core() -> pd.DataFrame:
    """Fetch the broker registry (id -> short name)."""
    logger.debug("bbrokers")
    r = await plus_request("get", "/stock/v1/brokerages")
...
async def exchanges_core() -> pd.DataFrame:
    """Fetch the exchange registry (id, name, delay in minutes)."""
    logger.debug("bexchanges")
    r = await plus_request("get", "/stock/v1/exchanges")
