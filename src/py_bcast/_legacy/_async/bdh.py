...
@http_retry
async def _bdh_fetch(s: httpx.AsyncClient, params: dict) -> httpx.Response:
...
@http_retry
async def _bdh_ohlcv_fetch(s: httpx.AsyncClient, params: dict) -> httpx.Response:
    """Isolated HTTP call for retry."""
    return await s.get(
...
async def bdh_ohlcv_one(
    ...
    await rate_limit_async()
    r = await _bdh_ohlcv_fetch(s, params)
