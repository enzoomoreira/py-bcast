# GENERATED by scripts/gen_sync.py from _legacy/_async/transport.py — DO NOT EDIT.
...
def _aetp_fetch(s: httpx.Client, path: str, params: dict) -> httpx.Response:
    ...
    return s.get(f"{BASE_URL}/aetp/output/{path}", params=params, timeout=30)
...
def _content_proxy_fetch(
    ...
    return s.get(f"{BASE_URL}/{endpoint}", params=params, timeout=timeout)
